...
def fetch_epa_values(team_number, year, event_code):
    ...
    with open("../epa_output.txt", "a") as f:
        ...
        for category in epa_categories:
            epa_value = sb.get_team_event(team_number, event_code, [category])
...
if teams:
    ...
    with open("../epa_output.txt", "w") as f:
        for team_number in teams:
            fetch_epa_values(team_number, year, event_code)
